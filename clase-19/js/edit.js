...
/*
getAlumn
Funcion que invoca endpoint alumnos con id de alumnos
*/
...
function updateAlumn(id, payload) {
  fetch(`http://localhost:3000/alumnos/${id}`, {
    ...
    location.replace('/clase-19/lisatar.html');
  });
}

/*
3.- setForm
Funcion que setea valor de alumno en formulaio y dispara evento
*/
